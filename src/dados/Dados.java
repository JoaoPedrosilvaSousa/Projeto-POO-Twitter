...
/**
 * Classe dados funciona como um banco de dados que armazena os dados da aplicação.
 * @author João Pedro
 * @author Rafael Gomes
 */
public class Dados {
	...
	/**
	 * Instancia a classe dados e instancia os usuario criados no banco de dados.
	 */
	public Dados() {
	...
	/**
	 * Retorna a lista de todos os usuarios da aplicação.
	 * @return List<Usuario>
	 */
	...
	/**
	 * Adiciona um usuario na lista de usuario da aplicação.
	 * @param usuario
	 */
	...
	/**
	 * Lista das ids todos os usuarios de acordo com o filtro de busca.
	 * @param usuario
	 * @return List<String>
	 */
	...
	/**
	 * Retorna lista de usuarios que nao sigo.
	 * @param usuario
	 * @return List<String>
	 */
	...
	/**
	 * Retorna uma lista de usuarios de acordo com o filtro de busca.
	 * @param nomeDeBusca
	 * @return
	 */
	...
	/**
	 * Retorna lista de postagens publicas de acordo com filtro de busca.
	 * @param textoDeBusca
	...
	/**
	 * Preenche os dados da aplicação.
	 */
